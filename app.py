...
MODEL_PATH = "https://github.com/archiducarmel/p9-oc/releases/download/clicks/recommender.model"
...
recommendations = get_cf_reco(clicks, userID, csr_item_user, csr_user_item, model_path=MODEL_PATH, n_reco=5,
                              train=False)
